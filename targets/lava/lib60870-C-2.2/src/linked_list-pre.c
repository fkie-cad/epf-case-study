...
LinkedList
LinkedList_getLastElement(int *data_flow, LinkedList list)
{
    while (list->next != 
                        ((void *)0)
                            ) {
...
LinkedList
LinkedList_create(int *data_flow)
{
    LinkedList newList;

    newList = (LinkedList) Memory_malloc(data_flow, sizeof(struct sLinkedList));
    newList->data = 
                   ((void *)0)
                       ;
    newList->next = 
...
void
LinkedList_destroyDeep(int *data_flow, LinkedList list, LinkedListValueDeleteFunction valueDeleteFunction)
{
    ...
    do {
        ...
        if (currentElement->data != 
            ...
            valueDeleteFunction(data_flow, currentElement->data);

        Memory_free(currentElement);
    }
    while (nextElement != 
                         ((void *)0)
                             );
...
void
LinkedList_destroy(int *data_flow, LinkedList list)
{
    LinkedList_destroyDeep(data_flow, list, Memory_free);
}
...
void
LinkedList_destroyStatic(int *data_flow, LinkedList list)
{
    LinkedList nextElement = list;
    LinkedList currentElement;
...
int
LinkedList_size(int *data_flow, LinkedList list)
{
    LinkedList nextElement = list;
    int size = 0;
...
void
LinkedList_add(int *data_flow, LinkedList list, void* data)
{
    LinkedList newElement = LinkedList_create(data_flow);

    newElement->data = data;

    LinkedList listEnd = LinkedList_getLastElement(data_flow, list);
...
LinkedList_remove(int *data_flow, LinkedList list, void* data)
{
...
LinkedList
LinkedList_insertAfter(int *data_flow, LinkedList list, void* data)
{
    LinkedList originalNextElement = LinkedList_getNext(data_flow, list);
...
LinkedList
LinkedList_getNext(int *data_flow, LinkedList list)
{
    return list->next;
}

LinkedList
LinkedList_get(int *data_flow, LinkedList list, int index)
{
    LinkedList element = LinkedList_getNext(data_flow, list);
