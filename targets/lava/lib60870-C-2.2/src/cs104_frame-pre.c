...
T104Frame
T104Frame_create(int *data_flow)
{
    T104Frame self = (T104Frame) Memory_malloc(data_flow, sizeof(struct sT104Frame));
...
void
T104Frame_destroy(int *data_flow, Frame super)
{
...
void
T104Frame_resetFrame(int *data_flow, Frame super)
{
    T104Frame self = (T104Frame) super;
...
void
T104Frame_setNextByte(int *data_flow, Frame super, uint8_t byte)
{
    T104Frame self = (T104Frame) super;
...
void
T104Frame_appendBytes(int *data_flow, Frame super, uint8_t* bytes, int numberOfBytes)
{
    T104Frame self = (T104Frame) super;
...
int
T104Frame_getMsgSize(int *data_flow, Frame super)
{
    T104Frame self = (T104Frame) super;
...
uint8_t*
T104Frame_getBuffer(int *data_flow, Frame super)
{
    T104Frame self = (T104Frame) super;
...
int
T104Frame_getSpaceLeft(int *data_flow, Frame super)
{
    T104Frame self = (T104Frame) super;

    return (249 + 6 - self->msgSize);
}
