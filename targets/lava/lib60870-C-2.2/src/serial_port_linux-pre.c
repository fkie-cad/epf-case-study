...
SerialPort_create(int *data_flow, const char* interfaceName, int baudRate, uint8_t dataBits, char parity, uint8_t stopBits)
{
    SerialPort self = (SerialPort) Memory_malloc(data_flow, sizeof(struct sSerialPort));
...
SerialPort_open(int *data_flow, SerialPort self)
{
    self->fd = open(self->interfaceName, 
                                        02 
                                               | 
                                                 0400 
                                                          | 
...
int
SerialPort_write(int *data_flow, SerialPort self, uint8_t* buffer, int startPos, int bufSize)
{
    ...
    self->lastSentTime = Hal_getTimeInMs(data_flow);
