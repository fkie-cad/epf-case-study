...
typedef 
       _Bool 
            (*CS101_ASDUReceivedHandler) (void* parameter, int address, CS101_ASDU asdu);
uint64_t
...
void
CS101_Master_setDIR(CS101_Master self, 
                                      _Bool 
                                           dir);
...
main(int argc, char** argv)
{
    ...
    CS101_Master master = CS101_Master_create(port, 
                                                   ((void *)0)
                                                       , 
                                                         ((void *)0)
    ...
    CS101_Master_setASDUReceivedHandler(master, asduReceivedHandler, 
                                                                    ((void *)0)
                                                                        );


    CS101_Master_setLinkLayerStateChanged(master, linkLayerStateChanged, 
                                                                        ((void *)0)
                                                                            );
