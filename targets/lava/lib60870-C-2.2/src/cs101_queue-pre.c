...
CS101_Queue_initialize(int *data_flow, CS101_Queue self, int maxQueueSize)
{
    ...
    BufferFrame_initialize(data_flow, &(self->encodeFrame), 
                                                ((void *)0)
                                                    , 0);
...
CS101_Queue_enqueue(int *data_flow, CS101_Queue self, CS101_ASDU asdu)
{
    CS101_Queue_lock(data_flow, self);
   ...
   _Bool 
    ...
    CS101_ASDU_encode(data_flow, asdu, (Frame)&(self->encodeFrame));
   ...
   0 
    ...
    CS101_Queue_unlock(data_flow, self);
}
...
CS101_Queue_dequeue(int *data_flow, CS101_Queue self, Frame resultStorage)
{
    ...
    if (self->entryCounter != 0) {
        ...
        if (resultStorage) {
            ...
            Frame_appendBytes(data_flow, frame, self->elements[currentIndex].buffer, self->elements[currentIndex].size);
