...
static int
getMillisecond(int *data_flow, uint8_t* encodedValue)
{
    return (encodedValue[0] + (encodedValue[1] * 0x100)) % 1000;
}

static void
setMillisecond(int *data_flow, uint8_t* encodedValue, int value)
{
...
static int
getSecond(int *data_flow, uint8_t* encodedValue)
{
    return (encodedValue[0] + (encodedValue[1] * 0x100)) / 1000;
}

static void
setSecond(int *data_flow, uint8_t* encodedValue, int value)
{
    int millies = encodedValue[0] + (encodedValue[1] * 0x100);
...
static int
getMinute(int *data_flow, uint8_t* encodedValue)
{
    return (encodedValue[2] & 0x3f);
}

static void
setMinute(int *data_flow, uint8_t* encodedValue, int value)
{
...
isInvalid(int *data_flow, uint8_t* encodedValue)
{
    return ((encodedValue[2] & 0x80) != 0);
}

static void
setInvalid(int *data_flow, uint8_t* encodedValue, 
                                 _Bool 
                                      value)
{
    if (value)
...
isSubstituted(int *data_flow, uint8_t* encodedValue)
{
    return ((encodedValue[2] & 0x40) == 0x40);
}

static void
setSubstituted(int *data_flow, uint8_t* encodedValue, 
                                     _Bool 
                                          value)
{
    if (value)
...
CP24Time2a_getMillisecond(int *data_flow, CP24Time2a self)
{
    return getMillisecond(data_flow, self->encodedValue);
}

void
CP24Time2a_setMillisecond(int *data_flow, CP24Time2a self, int value)
{
    setMillisecond(data_flow, self->encodedValue, value);
}

int
CP24Time2a_getSecond(int *data_flow, CP24Time2a self)
{
    return getSecond(data_flow, self->encodedValue);
}

void
CP24Time2a_setSecond(int *data_flow, CP24Time2a self, int value)
{
    setSecond(data_flow, self->encodedValue, value);
}

int
CP24Time2a_getMinute(int *data_flow, CP24Time2a self)
{
    return getMinute(data_flow, self->encodedValue);
}
...
CP24Time2a_setMinute(int *data_flow, CP24Time2a self, int value)
{
    setMinute(data_flow, self->encodedValue, value);
}
...
CP24Time2a_isInvalid(int *data_flow, CP24Time2a self)
{
    return isInvalid(data_flow, self->encodedValue);
}
...
CP24Time2a_setInvalid(int *data_flow, CP24Time2a self, 
                                      _Bool 
                                           value)
{
    setInvalid(data_flow, self->encodedValue, value);
}
...
CP24Time2a_isSubstituted(int *data_flow, CP24Time2a self)
{
    return isSubstituted(data_flow, self->encodedValue);
}
...
CP24Time2a_setSubstituted(int *data_flow, CP24Time2a self, 
                                          _Bool 
                                               value)
{
    setSubstituted(data_flow, self->encodedValue, value);
}
static time_t
my_mktime(int *data_flow, const struct tm * ptm)
{
    int m, y = ptm->tm_year;
...
CP32Time2a_create(int *data_flow, CP32Time2a self)
{
    if (self == 
        ...
        self = (CP32Time2a) Memory_calloc(data_flow, 1, sizeof(struct sCP32Time2a));
    else
...
CP32Time2a_setMillisecond(int *data_flow, CP32Time2a self, int value)
{
    int millies = (CP32Time2a_getSecond(data_flow, self) * 1000) + value;
...
CP32Time2a_setFromMsTimestamp(int *data_flow, CP32Time2a self, uint64_t timestamp)
{
    ...
    CP32Time2a_setSecond(data_flow, self, tmTime.tm_sec);

    CP32Time2a_setMillisecond(data_flow, self, msPart);

    CP32Time2a_setMinute(data_flow, self, tmTime.tm_min);

    CP32Time2a_setHour(data_flow, self, tmTime.tm_hour);
}
...
CP56Time2a_createFromMsTimestamp(int *data_flow, CP56Time2a self, uint64_t timestamp)
{
    if (self == 
        ...
        self = (CP56Time2a) Memory_calloc(data_flow, 1, sizeof(struct sCP56Time2a));
    else
    ...
    if (self != 
        ...
        CP56Time2a_setFromMsTimestamp(data_flow, self, timestamp);
...
CP56Time2a_setFromMsTimestamp(int *data_flow, CP56Time2a self, uint64_t timestamp)
{
    ...
    CP56Time2a_setMillisecond(data_flow, self, msPart);

    CP56Time2a_setSecond(data_flow, self, tmTime.tm_sec);

    CP56Time2a_setMinute(data_flow, self, tmTime.tm_min);

    CP56Time2a_setHour(data_flow, self, tmTime.tm_hour);

    CP56Time2a_setDayOfMonth(data_flow, self, tmTime.tm_mday);


    CP56Time2a_setDayOfWeek(data_flow, self, 0);

    CP56Time2a_setMonth(data_flow, self, tmTime.tm_mon + 1);

    CP56Time2a_setYear(data_flow, self, tmTime.tm_year);
}
...
CP56Time2a_toMsTimestamp(int *data_flow, CP56Time2a self)
{
    ...
    tmTime.tm_sec = CP56Time2a_getSecond(data_flow, self);
    tmTime.tm_min = CP56Time2a_getMinute(data_flow, self);
    tmTime.tm_hour = CP56Time2a_getHour(data_flow, self);
    tmTime.tm_mday = CP56Time2a_getDayOfMonth(data_flow, self);
    tmTime.tm_mon = CP56Time2a_getMonth(data_flow, self) - 1;
    tmTime.tm_year = CP56Time2a_getYear(data_flow, self) + 100;

    time_t timestamp = my_mktime(data_flow, &tmTime);

    uint64_t msTimestamp = ((uint64_t) (timestamp * (uint64_t) 1000)) + CP56Time2a_getMillisecond(data_flow, self);
