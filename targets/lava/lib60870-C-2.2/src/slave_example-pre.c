...
void
CS101_Slave_setDIR(CS101_Slave self, 
                                    _Bool 
                                         dir);
void
...
static void
rawMessageHandler (void* parameter, uint8_t* msg, int msgSize, 
                                                              _Bool 
                                                                   sent)
{
    if (sent)
...
interrogationHandler(void* parameter, IMasterConnection connection, CS101_ASDU asdu, uint8_t qoi)
{
    ...
    if (qoi == 20) {
        ...
        CS101_ASDU newAsdu = CS101_ASDU_create(alParams, 
                                                        0
        ...
        CS101_ASDU_addInformationObject(newAsdu, (InformationObject)
            MeasuredValueScaled_create((MeasuredValueScaled) io, 101, 23, 0));

        CS101_ASDU_addInformationObject(newAsdu, (InformationObject)
            MeasuredValueScaled_create((MeasuredValueScaled) io, 102, 2300, 0));
        ...
        CS101_ASDU_addInformationObject(newAsdu, (InformationObject)
            SinglePointInformation_create((SinglePointInformation) io, 105, 
                                                                           0
                                                                                , 0));
        ...
        CS101_ASDU_addInformationObject(newAsdu, io = (InformationObject) SinglePointInformation_create(
                                                                                                       ((void *)0)
                                                                                                           , 300, 
                                                                                                                  1
                                                                                                                      , 0));
        CS101_ASDU_addInformationObject(newAsdu, (InformationObject) SinglePointInformation_create((SinglePointInformation) io, 301, 
                                                                                                                                    0
                                                                                                                                         , 0));
        CS101_ASDU_addInformationObject(newAsdu, (InformationObject) SinglePointInformation_create((SinglePointInformation) io, 302, 
                                                                                                                                    1
                                                                                                                                        , 0));
        CS101_ASDU_addInformationObject(newAsdu, (InformationObject) SinglePointInformation_create((SinglePointInformation) io, 303, 
                                                                                                                                    0
                                                                                                                                         , 0));
        CS101_ASDU_addInformationObject(newAsdu, (InformationObject) SinglePointInformation_create((SinglePointInformation) io, 304, 
                                                                                                                                    1
                                                                                                                                        , 0));
        CS101_ASDU_addInformationObject(newAsdu, (InformationObject) SinglePointInformation_create((SinglePointInformation) io, 305, 
                                                                                                                                    0
                                                                                                                                         , 0));
        CS101_ASDU_addInformationObject(newAsdu, (InformationObject) SinglePointInformation_create((SinglePointInformation) io, 306, 
                                                                                                                                    1
                                                                                                                                        , 0));
        CS101_ASDU_addInformationObject(newAsdu, (InformationObject) SinglePointInformation_create((SinglePointInformation) io, 307, 
                                                                                                                                    0
                                                                                                                                         , 0));
...
main(int argc, char** argv)
{
    ...
    CS101_Slave slave = CS101_Slave_create(port, 
                                                ((void *)0)
                                                    , 
                                                      ((void *)0)
    ...
    CS101_Slave_setClockSyncHandler(slave, clockSyncHandler, 
                                                            ((void *)0)
                                                                );


    CS101_Slave_setInterrogationHandler(slave, interrogationHandler, 
                                                                    ((void *)0)
                                                                        );


    CS101_Slave_setASDUHandler(slave, asduHandler, 
                                                  ((void *)0)
                                                      );
    ...
    while (running) {
        ...
        if (Hal_getTimeInMs() > (lastMessageSent + 1000)) {
            ...
            CS101_ASDU newAsdu = CS101_ASDU_create(alParameters, 
                                                                0
