...
CS101_Master
CS101_Master_create(int *data_flow, SerialPort port, LinkLayerParameters llParameters, CS101_AppLayerParameters alParameters, IEC60870_LinkLayerMode mode);
...
void
CS101_Master_run(int *data_flow, CS101_Master self);
void
CS101_Master_start(int *data_flow, CS101_Master self);
...
void
CS101_Master_stop(int *data_flow, CS101_Master self);
void
CS101_Master_addSlave(int *data_flow, CS101_Master self, int address);
void
CS101_Master_pollSingleSlave(int *data_flow, CS101_Master self, int address);




void
CS101_Master_destroy(int *data_flow, CS101_Master self);
void
CS101_Master_setDIR(int *data_flow, CS101_Master self, 
                                      _Bool 
                                           dir);
...
void
CS101_Master_setOwnAddress(int *data_flow, CS101_Master self, int address);
void
CS101_Master_useSlaveAddress(int *data_flow, CS101_Master self, int address);
CS101_AppLayerParameters
CS101_Master_getAppLayerParameters(int *data_flow, CS101_Master self);
...
LinkLayerParameters
CS101_Master_getLinkLayerParameters(int *data_flow, CS101_Master self);

_Bool

CS101_Master_isChannelReady(int *data_flow, CS101_Master self, int address);
...
void
CS101_Master_sendLinkLayerTestFunction(int *data_flow, CS101_Master self);
void
CS101_Master_sendInterrogationCommand(int *data_flow, CS101_Master self, CS101_CauseOfTransmission cot, int ca, QualifierOfInterrogation qoi);
void
CS101_Master_sendCounterInterrogationCommand(int *data_flow, CS101_Master self, CS101_CauseOfTransmission cot, int ca, uint8_t qcc);
void
CS101_Master_sendReadCommand(int *data_flow, CS101_Master self, int ca, int ioa);
...
void
CS101_Master_sendClockSyncCommand(int *data_flow, CS101_Master self, int ca, CP56Time2a time);
void
CS101_Master_sendTestCommand(int *data_flow, CS101_Master self, int ca);
void
CS101_Master_sendProcessCommand(int *data_flow, CS101_Master self, CS101_CauseOfTransmission cot, int ca, InformationObject command);
void
CS101_Master_sendASDU(int *data_flow, CS101_Master self, CS101_ASDU asdu);
...
void
CS101_Master_setASDUReceivedHandler(int *data_flow, CS101_Master self, CS101_ASDUReceivedHandler handler, void* parameter);




void
CS101_Master_setLinkLayerStateChanged(int *data_flow, CS101_Master self, IEC60870_LinkLayerStateChangedHandler handler, void* parameter);
...
void
CS101_Master_setRawMessageHandler(int *data_flow, CS101_Master self, IEC60870_RawMessageHandler handler, void* parameter);
void
CS101_Master_setIdleTimeout(int *data_flow, CS101_Master self, int timeoutInMs);
...
IBalancedApplicationLayer_GetUserData (int *data_flow, void* parameter, Frame frame)
{
    ...
    CS101_Queue_lock(data_flow, &(self->userDataQueue));

    ret = CS101_Queue_dequeue(data_flow, &(self->userDataQueue), frame);

    CS101_Queue_unlock(data_flow, &(self->userDataQueue));
                                                                                 ...
                                                                                 isBroadcast, int userDataStart, int userDataLength)
{
    ...
    if (self->asduReceivedHandler)
        self->asduReceivedHandler(data_flow, self->asduReceivedHandlerParameter, 0, asdu);
...
static void
IPrimaryApplicationLayer_AccessDemand(int *data_flow, void* parameter, int slaveAddress)
{
    CS101_Master self = (CS101_Master) parameter;
   ...
   0 
    ...
    LinkLayerPrimaryUnbalanced_requestClass1Data(data_flow, self->unbalancedLinkLayer, slaveAddress);
}

static void
IPrimaryApplicationLayer_UserData(int *data_flow, void* parameter, int slaveAddress, uint8_t* msg, int start, int length)
{
    CS101_Master self = (CS101_Master) parameter;

    CS101_ASDU asdu = CS101_ASDU_createFromBuffer(data_flow, &(self->alParameters), msg + start, length);

    if (self->asduReceivedHandler)
        self->asduReceivedHandler(data_flow, self->asduReceivedHandlerParameter, slaveAddress, asdu);
...
static void
IPrimaryApplicationLayer_Timeout (int *data_flow, void* parameter, int slaveAddress)
{
...
CS101_Master
CS101_Master_create(int *data_flow, SerialPort serialPort, LinkLayerParameters llParameters, CS101_AppLayerParameters alParameters, IEC60870_LinkLayerMode linkLayerMode)
{
    CS101_Master self = (CS101_Master) Memory_malloc(data_flow, sizeof(struct sCS101_Master));
    ...
    if (self != 
        ...
        if (linkLayerMode == IEC60870_LINK_LAYER_UNBALANCED) {
            ...
            self->unbalancedLinkLayer = LinkLayerPrimaryUnbalanced_create(data_flow, self->transceiver,
                    &(self->linkLayerParameters), &cs101UnbalancedAppLayerInterface, self);
        }
        else {
            CS101_Queue_initialize(data_flow, &(self->userDataQueue), 10);
            ...
            LinkLayerBalanced_setDIR(data_flow, self->balancedLinkLayer, 
                                                             1
                                                                 );
        }

        self->asduReceivedHandler = 
                                   ((void *)0)
                                       ;
...
CS101_Master_run(int *data_flow, CS101_Master self)
{
    if (self->unbalancedLinkLayer) {
        ...
        LinkLayerPrimaryUnbalanced_run(data_flow, self->unbalancedLinkLayer);
    }
    else
...
static void*
masterMainThread(int *data_flow, void* parameter)
{
    CS101_Master self = (CS101_Master) parameter;
    ...
    while (self->isRunning) {
        CS101_Master_run(data_flow, self);
    }
...
CS101_Master_start(int *data_flow, CS101_Master self)
{
    ...
    if (self->workerThread == 
        ...
        self->workerThread = Thread_create(data_flow, masterMainThread, self, 
                                                                  0
                                                                       );
...
CS101_Master_destroy(int *data_flow, CS101_Master self)
{
    if (self) {
        ...
        if (self->balancedLinkLayer) {
            ...
            CS101_Queue_dispose(data_flow, &(self->userDataQueue));
        }

        if (self->unbalancedLinkLayer) {
            LinkLayerPrimaryUnbalanced_destroy(data_flow, self->unbalancedLinkLayer);
        }
...
CS101_Master_setDIR(int *data_flow, CS101_Master self, 
                                      _Bool 
                                           dir)
{
    LinkLayer_setDIR(data_flow, self->linkLayer, dir);
}
...
{
    if (self->linkLayer)
        LinkLayer_setAddress(data_flow, self->linkLayer, address);
}
...
{
    if (self->unbalancedLinkLayer)
        return LinkLayerPrimaryUnbalanced_isChannelAvailable(data_flow, self->unbalancedLinkLayer, address);
...
{
    if (self->unbalancedLinkLayer)
        LinkLayerPrimaryUnbalanced_sendLinkLayerTestFunction(data_flow, self->unbalancedLinkLayer,
                self->slaveAddress);
    else if (self->balancedLinkLayer)
        LinkLayerBalanced_sendLinkLayerTestFunction(data_flow, self->balancedLinkLayer);
}
...
CS101_Master_sendInterrogationCommand(int *data_flow, CS101_Master self, CS101_CauseOfTransmission cot, int ca, QualifierOfInterrogation qoi)
{
    ...
    CS101_ASDU asdu = CS101_ASDU_initializeStatic(data_flow, &_asdu, &(self->alParameters), 
                                                                                0
                                                                                     , cot, self->alParameters.originatorAddress, ca, 
                                                                                                                                      0
                                                                                                                                           , 
                                                                                                                                             0
                                                                                                                                                  );
    ...
    InformationObject io = (InformationObject) InterrogationCommand_create(data_flow, &_io, 0, qoi);

    CS101_ASDU_addInformationObject(data_flow, asdu, io);

    CS101_Master_sendASDU(data_flow, self, asdu);
}
...
CS101_Master_sendCounterInterrogationCommand(int *data_flow, CS101_Master self, CS101_CauseOfTransmission cot, int ca, uint8_t qcc)
{
    ...
    InformationObject io = (InformationObject) CounterInterrogationCommand_create(data_flow, &_io, 0, qcc);
...
CS101_Master_sendReadCommand(int *data_flow, CS101_Master self, int ca, int ioa)
{
    ...
    CS101_ASDU asdu = CS101_ASDU_initializeStatic(data_flow, &_asdu, &(self->alParameters), 
                                                                                0
                                                                                     , CS101_COT_REQUEST, self->alParameters.originatorAddress, ca, 
                                                                                                                                                    0
                                                                                                                                                         , 
                                                                                                                                                           0
                                                                                                                                                                );
    ...
    InformationObject io = (InformationObject) ReadCommand_create(data_flow, &_io, ioa);
...
CS101_Master_sendClockSyncCommand(int *data_flow, CS101_Master self, int ca, CP56Time2a time)
{
    ...
    CS101_ASDU asdu = CS101_ASDU_initializeStatic(data_flow, &_asdu, &(self->alParameters), 
                                                                                0
                                                                                     , CS101_COT_ACTIVATION, self->alParameters.originatorAddress, ca, 
                                                                                                                                                       0
                                                                                                                                                            , 
                                                                                                                                                              0
                                                                                                                                                                   );
    ...
    InformationObject io = (InformationObject) ClockSynchronizationCommand_create(data_flow, &_io, 0, time);
...
CS101_Master_sendTestCommand(int *data_flow, CS101_Master self, int ca)
{
    ...
    InformationObject io = (InformationObject) TestCommand_create(data_flow, &_io);
...
CS101_Master_sendProcessCommand(int *data_flow, CS101_Master self, CS101_CauseOfTransmission cot, int ca, InformationObject command)
{
    ...
    CS101_ASDU_addInformationObject(data_flow, asdu, command);
...
isBroadcastAddress(int *data_flow, CS101_Master self, int address)
{
...
CS101_Master_sendASDU(int *data_flow, CS101_Master self, CS101_ASDU asdu)
{
    if (self->unbalancedLinkLayer) {
        ...
        uint8_t buffer[256];
        BufferFrame_initialize(data_flow, &bufferFrame, buffer, 0);

        CS101_ASDU_encode(data_flow, asdu, (Frame) &bufferFrame);

        if (isBroadcastAddress(data_flow, self, self->slaveAddress))
            LinkLayerPrimaryUnbalanced_sendNoReply(data_flow, self->unbalancedLinkLayer, self->slaveAddress, &bufferFrame);
        else
            LinkLayerPrimaryUnbalanced_sendConfirmed(data_flow, self->unbalancedLinkLayer, self->slaveAddress, &bufferFrame);
    }
    else
        CS101_Queue_enqueue(data_flow, &(self->userDataQueue), asdu);
}
...
{
    if (self->unbalancedLinkLayer)
        LinkLayerPrimaryUnbalanced_addSlaveConnection(data_flow, self->unbalancedLinkLayer, address);
}
...
{
    if (self->unbalancedLinkLayer) {
        LinkLayerPrimaryUnbalanced_requestClass2Data(data_flow, self->unbalancedLinkLayer, address);
    }
}
...
CS101_Master_setLinkLayerStateChanged(int *data_flow, CS101_Master self, IEC60870_LinkLayerStateChangedHandler handler, void* parameter)
{
    if (self->linkLayerMode == IEC60870_LINK_LAYER_BALANCED) {
        ...
        LinkLayerPrimaryUnbalanced_setStateChangeHandler(data_flow, self->unbalancedLinkLayer, handler, parameter);
    }
}
